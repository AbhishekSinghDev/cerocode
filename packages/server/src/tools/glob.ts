...
export function createGlobTool(cwd: string) {
  return tool({
    description:
      "Fine files matching a glob pattern. Returns a list paths relative to the project root. Skips node_modules and hidden directories.",
